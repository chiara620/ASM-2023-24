...
.type itoafile, @function	# dichiarazione della funzione itoa che
							...
							# stato caricato nel registro %eax e lo stampa 
							# nel file di cui e' stato passato il file descriptor
...
stampa:
    ...
    mov $4, %eax        # syscall write on file
    mov fd, %ebx        # File descriptor
    leal car, %ecx      # Carico in ECX cosa stampare
